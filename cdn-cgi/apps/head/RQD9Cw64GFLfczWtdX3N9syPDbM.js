;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="99513a229daed0310fc3afe3128a34f5";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){CloudflareApps.internal=CloudflareApps.internal||{};var errors=[];CloudflareApps.internal.placementErrors=errors;var errorHashes={}
...
return false;}})();;CloudflareApps.installs["bAz-meY3Ibvb"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["bAz-meY3Ibvb"].options={"id":"UA-23828714-1","social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['bAz-meY3Ibvb'].URLPatterns)){(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');};if(CloudflareApps.matchPage(CloudflareApps.installs['bAz-meY3Ibvb'].URLPatterns)){(function(){var options=CloudflareApps.installs['bAz-meY3Ibvb'].options
